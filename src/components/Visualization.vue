...
const scaleRuler = computed(() => {
  ...
  const units = [
    ...
    { name: '1e10m', meters: 1e10, ref: '33× Earth to Moon' },
    { name: '1e9m', meters: 1e9, ref: '3× Earth to Moon' },
    { name: '1e8m', meters: 1e8, ref: '100 million m' },
    { name: '1e7m', meters: 1e7, ref: 'Earth diameter' },
    ...
    { name: '1μm', meters: 1e-6, ref: 'Bacteria (E. coli)' },
    { name: '100nm', meters: 1e-7, ref: 'Virus (COVID-19 ~100nm)' },
    { name: '10nm', meters: 1e-8, ref: 'Protein, cell membrane thickness' },
    { name: '1nm', meters: 1e-9, ref: 'DNA helix diameter' },
    { name: '100pm', meters: 1e-10, ref: 'High-energy X-ray' },
    { name: '10pm', meters: 1e-11, ref: 'Hydrogen atom diameter' },
    { name: '1pm', meters: 1e-12, ref: 'X-ray wavelength' },
    { name: '100fm', meters: 1e-13, ref: '~100× atomic nucleus (Uranium ~15fm)' },
    { name: '10fm', meters: 1e-14, ref: 'Atomic nucleus size' },
    { name: '1fm', meters: 1e-15, ref: 'Proton radius ~0.84fm' },
    { name: '100am', meters: 1e-16, ref: 'Bottom quark scale' },
    { name: '10am', meters: 1e-17, ref: 'Weak force interaction range' },
    { name: '1am', meters: 1e-18, ref: 'Electron scale' },
    { name: '100zm', meters: 1e-19, ref: 'Charm quark size' },
    { name: '10zm', meters: 1e-20, ref: 'Quark interactions' },
    { name: '1zm', meters: 1e-21, ref: 'Neutrino Compton wavelength' },
    { name: '100ym', meters: 1e-22, ref: 'Preon scale (hypothetical)' },
    { name: '10ym', meters: 1e-23, ref: 'Beyond standard model' },
    { name: '1ym', meters: 1e-24, ref: 'Smallest confirmed SI unit' },
    { name: '100rm', meters: 1e-25, ref: 'String theory scale' },
    { name: '10rm', meters: 1e-26, ref: 'Beyond experimental reach' },
    { name: '1rm', meters: 1e-27, ref: 'Theoretical minimum length' },
    { name: '100qm', meters: 1e-28, ref: 'Planck scale approaches' },
    { name: '10qm', meters: 1e-29, ref: 'Quantum gravity regime' },
    { name: '1qm', meters: 1e-30, ref: 'Spacetime may become quantized' },
    { name: '1e-31m', meters: 1e-31, ref: 'Spacetime foam' },
    { name: '1e-32m', meters: 1e-32, ref: 'Quantum gravity realm' },
    { name: '1e-33m', meters: 1e-33, ref: 'Spacetime itself becomes quantized' },
